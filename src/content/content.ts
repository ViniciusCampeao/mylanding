  ...
  portfolio: {
    ...
    projects: [
      ...
      /* ── 02 · Pesquisa ──────────────────────────────────── */
      {
        ...
        description: l(
          "Sistema de contagem automática de colônias bacterianas em placas de Petri, unindo processamento de imagem, hardware próprio (Raspberry Pi + câmera) e modelagem 3D da estrutura de captura. Parte da minha Iniciação Científica, aplicando visão computacional à bioinformática.",
          "Automatic bacterial colony counting system for Petri dishes, combining image processing, custom hardware (Raspberry Pi + camera), and a 3D-modeled capture housing. Part of my undergraduate research, applying computer vision to bioinformatics.",
        ),
      ...
      },
      {
        ...
        description: l(
          "Sistema de monitoramento e automação de cultivo com sensores de pH, umidade e luminosidade conectados via ESP32 a um servidor central. Além do dashboard remoto, o sistema automatiza irrigação, controle de pH e adição de nutrientes.",
          "Crop monitoring and automation system with pH, humidity, and light sensors connected via ESP32 to a central server. Besides the remote dashboard, the system automates irrigation, pH control, and nutrient dosing.",
        ),
      ...
      },
      {
        ...
        description: l(
          "Projeto baseado em ESP32 e nRF24, explorando comunicação sem fio, interface gráfica em display OLED, firmware embarcado e integração entre diferentes módulos de hardware.",
          "ESP32 and nRF24-based project exploring wireless communication, an OLED display interface, embedded firmware, and integration between different hardware modules.",
        ),
        stack: ["ESP32", "nRF24", "OLED", "Firmware embarcado"],
        role: l("Firmware e integração de hardware", "Firmware and hardware integration"),
        status: "archived",
        category: "embedded-iot",
        color: "#8a3a6a",
      },
      {
        ...
        description: l(
          "Experimentos com captura de áudio digital usando o microfone INMP441 via interface I2S, processamento do sinal no ESP32 e visualização de dados em display.",
          "Experiments capturing digital audio with the INMP441 microphone over I2S, signal processing on the ESP32, and data visualization on a display.",
        ),
        stack: ["ESP32", "INMP441", "I2S", "Processamento de áudio"],
        role: l("Processamento de áudio embarcado", "Embedded audio processing"),
        status: "archived",
        category: "embedded-iot",
        color: "#7a8a2a",
      },
